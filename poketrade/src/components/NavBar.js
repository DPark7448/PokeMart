    ...
    <nav className="navbar navbar-light bg-light border-bottom py-3">
      <div className="container-fluid d-flex align-items-center justify-content-between position-relative">
        ...
        <div className="d-flex gap-2">
          <Link href="/login" className="btn btn-outline-dark btn-sm rounded-pill px-3 py-1">Sign in</Link>
          <Link href="/register" className="btn btn-dark btn-sm rounded-pill px-3 py-1">Register</Link>
        </div>
      </div>
    </nav>
  );
